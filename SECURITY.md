...
Please submit your findings as [security advisories](https://github.com/wazuh/wazuh-packages/security/advisories) under the "Security" tab in the relevant GitHub repository. Alternatively, you may send the details of your findings to security@wazuh.com.
