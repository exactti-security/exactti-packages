...
aux_file_name = 'exactti-agent.p5m.1.aux'
...
def main():
    ...
    parser.add_argument("-p", "--p5m1_file_path", type=str, help="Path where the exactti-agent.p5m.1 file is located.", required=True)
